...
bool TileMap::load(const std::filesystem::path &tileset, sf::Vector2u tileSize, const int *tiles, unsigned int width, unsigned int height, unsigned int horizontal, unsigned int vertical)
{
